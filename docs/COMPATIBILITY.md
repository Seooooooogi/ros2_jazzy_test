...
| VS Code | 1.120.0 (실측), 패키지 빌드 `1.120.0-1778619059` | `resources/base-install.sh vscode` (install.sh step 11) | `wget code.visualstudio.com/sboot/stable?platform=linux-deb-x64`. 설치 크기 약 645MB |

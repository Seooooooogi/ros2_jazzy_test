...
- **[문서] venv ws 이름은 미정**: Notion 2페이지는 `cobot_venv_ws` 인데 레포(`scripts/venv-demo/LAB.md` 약 45곳, `scripts/venv-demo/uv/setup.sh`, `setup-app.sh:191-193` 안내문, `resources/colcon-build.sh:15`)는 **`cobot_demo_ws` 그대로** — 같은 종류의 diverge 잔존, 사용자 결정 대기.

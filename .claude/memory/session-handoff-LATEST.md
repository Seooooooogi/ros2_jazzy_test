...
## Last updated
2026-06-29 ([실측]) — **[실측]** venv 실습 가이드 push + voice docker run 이름 충돌 가드 + docker 재설치 멱등 수정 + realsense ROS snapshot 정합. `feat/application-containers` origin 동기(HEAD `0ccf5ac`).
